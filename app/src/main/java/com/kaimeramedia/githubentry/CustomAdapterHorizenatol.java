...
public class CustomAdapterHorizenatol extends RecyclerView.Adapter<CustomAdapterHorizenatol.MyViewHolder> {
    ...
    public CustomAdapterHorizenatol(ArrayList<DataClass> data) {
        this.dataSet = data;
    }
